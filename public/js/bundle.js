...
var showMap = function showMap() {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: "bottom"
    }).setLngLat(loc.coordinates).addTo(map); // add location popup
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var stripe, tourID, session, result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe("pk_test_51GtfuGAcBX8weQJc0jJ44dHKPyIjf8awqOmQYDjwZORqgOOHGQ6uAbo865OJCZA56JR0fwvwbtloLAktpkt2lTgm00pij2w37k");
            _context.prev = 1;
            document.getElementById('book-tour').innerHTML = 'Processing...';
            tourID = document.getElementById('book-tour').getAttribute('data-tour-id'); // (1) Get checkout session from the API
          ...
          case 6:
            _context.next = 8;
            return _context.sent.data.session;
          ...
          case 11:
            ...
            return _context.abrupt("return", (0, _alerts.showAlert)('error', result.error.message));
          ...
          case 16:
            _context.prev = 16;
            _context.t0 = _context["catch"](1);
            (0, _alerts.showAlert)('error', _context.t0.response ? _context.t0.response.data.message : _context.t0.message);
...
var updateUserData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var userName, email, photo, data, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            photo = document.getElementById("photo").files[0]; // multipart formdata
            ...
            _context.prev = 9;
            _context.next = 12;
            return _axios.default.patch("http://localhost:5000/api/v1/users/updateMe", data);
...
var updateUserPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var currentPassword, newPassword, confirmPassword, data, res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 9;
            _context2.next = 12;
            return _axios.default.patch("http://localhost:5000/api/v1/users/update-password", data);
...
var bookTourButton = document.getElementById('book-tour'); // login
