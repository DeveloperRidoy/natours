      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            tourID = document.getElementById("book-tour").getAttribute("data-tour-id"); // (2) Get checkout session from the API
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 9;
            _context2.next = 12;
            return _axios.default.patch("/api/v1/users/update-password", data);
...
loginForm && loginForm.addEventListener("submit", _login.login); // logout

logoutButton && logoutButton.addEventListener('click', _logout.logout); // show map

mapBox && (0, _mapbox.showMap)(); // update user data
